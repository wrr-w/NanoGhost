...
# memory_explore — query multi-layer graph
...
def memory_explore(args: dict, ctx: dict) -> ToolResult:
    ...
    try:
        ...
        if action == "node":
            ...
            # Filter by to_code prefix match
            ...
            from agent_core.memory.classifier import level_name
...
# memory_read — read memory.md with layered disclosure
...
def handle_list_cards(args: dict, ctx: dict) -> ToolResult:
    ...
    from agent_core.memory.cards import list_card_index
...
# get_card_detail — expand one card
...
def handle_get_card_detail(args: dict, ctx: dict) -> ToolResult:
    ...
    from agent_core.memory.cards import get_card_detail
